...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('creativesapp', '0004_project_delete_rating'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='creativesapp.project')),
